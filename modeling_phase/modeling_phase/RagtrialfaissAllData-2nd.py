...
DATA_DIR = r"G:\Ela\study\4-Ds\S2\PIDS\phase2\Rag\DATA\cleaned_texts" # Directory with text files to index
...
def test_rag_system(question: str):
    ...
    try:
        answer = generate_answer_with_llm(question, context, OPENROUTER_API_KEY, MISTRAL_MODEL)
